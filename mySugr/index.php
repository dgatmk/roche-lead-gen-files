...
<body>
  ...
  <img id="header-image" src="images/mySugr.svg">
  <div id="form-body" class="imago">
    <form id="acd-form" action="php/roche-lead.php" method="POST" name="mySugrForm">
      ...
      <div class="row">
        <textarea name="comments" cols="30" rows="10" maxlength="1000" placeholder="Comments"></textarea>
      </div>
      <div class="row">
